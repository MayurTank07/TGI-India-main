...
export default function BPOHero() {
  ...
  const { badge, heading, description, primaryCTA, secondaryCTA, image } = content.services.bpo.hero;
    ...
    <section className="bg-[#F5F5F7] py-16 md:py-28 px-5 md:px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-10 md:gap-16 lg:gap-24">
        ...
        <div className="flex justify-center md:justify-end">
          <img src={image} alt="BPO team" className="w-full max-w-sm md:max-w-md lg:w-[460px] h-[320px] sm:h-[400px] md:h-[480px] lg:h-[560px] object-cover rounded-2xl md:rounded-[28px]" />
        </div>
      </div>
    </section>
  );
