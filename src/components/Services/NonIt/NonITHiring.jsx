...
export default function NonITHiring() {
  ...
  const { heading, description, items } = content.services.nonit.offerings;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-10">
          {items.map((service, index) => (
            <div key={index}>
              <img src={service.img} alt={service.title} className="w-full h-[280px] md:h-[400px] lg:h-[500px] object-cover rounded-2xl md:rounded-3xl mb-4 md:mb-5" />
